...
def main() -> int:
    ...
    required_text = {
        ...
        ROOT / "passage-links.js": ("selectionContext", "paragraphIndex", "blocks", "Math.imul", "navigator.clipboard", 'document.execCommand("copy")', "location.hash", 'parameters.has("notrack")'),
        ROOT / "reader-insights.js": ('send("view")', 'send("complete")', "/api/message", "completionMarker", "paragraphIndex", "selectionActions.dataset.quote"),
        ROOT / "_includes" / "reader-message.html": ("data-reader-message-dialog", "data-reader-selection-actions", "data-reader-selection-note", "data-reader-selection-copy", 'name="quote"', 'name="paragraph_index"'),
