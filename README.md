...
- 中文原文故意省略性别、使用“TA”，或以“他”承担泛指而非明确男性人物时，英文不要机械补成 `he`。根据叙述关系使用单数 `they`、`it`、重复名字或省略代词；以保留原文的不确定性和叙述距离为准。
...
- 像 `Zhuge Liang` 这样需要较多中文文化背景的人物，以及《道德经》、古诗文等未在正文说明来源的典故或引文，可在首次出现处使用同一弹窗脚注，简要交代身份、作者或作品名；正文已经自然说明清楚时不重复注释。
...
- 文章网址添加 `?notrack=1` 时，不发送阅读统计、不显示私信入口，也不保存阅读位置；段落定位与“复制本段链接”仍可独立使用。
