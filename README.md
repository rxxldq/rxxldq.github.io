...
- 普通新架构文章位于 `works/`，中文与英文分别保存为 `.zh.md` 和 `.en.md`。需要在根目录明确保留固定网址的文章，根目录只放一个调用公共模板的薄入口，正文唯一副本放在 `_includes/works/`。
...
- 旧式整页 HTML 只在迁移核对期间保留；确认正文、图片、段落与公开页面完整后即可删除，避免新旧框架和正文副本长期堆叠。
